...
#_cifar10  = os.path.join(settings.PATH, _datasets_root, 'cifar10')
#_gtsrb  = os.path.join(settings.PATH, _datasets_root, 'gtsrb')
#_svhn  = os.path.join(settings.PATH, _datasets_root, 'svhn')
...
class GTSRB:
    ...
    inj_rate=.0, trigger_name='checkerboard', target_class=18, seed=0):
        print("GTSRB::init - doNormalization is", doNormalization)  # added by ionut
        self.batch_size = batch_size
        self.img_size = 32
        self.num_classes = 43
        self.num_test = 12630
